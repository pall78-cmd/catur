...
export const annotations: Record<number, MoveAnalysis> = {
  ...
  25: { ply: 25, annotation: "Lompatan putus asa ke lubang di pusat, berharap menciptakan kekacauan." },
  26: { ply: 26, annotation: "Taktik brilian! Hitam merebut bidak pusat sementara kuda f5 tampaknya sedang diancam oleh menteri." },
  ...
  36: { ply: 36, annotation: "Menawarkan pertukaran ratu. Saat Anda memiliki keunggulan posisi yang besar dan sedang menyerang, menukar ratu dapat menyederhanakan permainan ke akhir game (endgame) yang mudah dimenangkan." },
  37: { ply: 37, annotation: "Putih menolak pertukaran, berharap menjaga komplikasi tetap ada." },
  ...
  53: { ply: 53, annotation: "Putih mengambil benteng di h7, tidak menyadari ancaman yang lebih besar." },
  54: { ply: 54, annotation: "Hitam mengabaikan hilangnya benteng dan mengambil kuda, menghancurkan perlindungan raja Putih." },
  55: { ply: 55, annotation: "Merebut kembali." },
  56: { ply: 56, annotation: "Blunder fatal dari Putih! Menteri di d3 tidak terjaga sepanjang waktu! Hitam dengan senang hati mengambilnya.", evaluation: "Blunder. Menteri (ratu) tidak dilindungi." },
